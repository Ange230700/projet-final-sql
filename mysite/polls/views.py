...
def indexDepartement(request):
    ...
    paginator = Paginator(departement, 10) # Show 10 contacts per page
...
def indexEmploye(request):
    ...
    paginator = Paginator(employe, 10) # Show 10 contacts per page
...
def indexPoste(request):
    ...
    paginator = Paginator(poste, 10) # Show 10 contacts per page
